...
- Two routes:
  - **Parse route**: document → OCR/parse to text ([ch. 11](../11-glm-ocr/index.md); [chapter 03](../03-image-processor/index.md)'s token budget decides whether it is readable) → text RAG. Controllable and traceable — the engineering mainstream
