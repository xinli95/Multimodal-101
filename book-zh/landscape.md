...
Part I 深挖一个模型，这一页是它的配重：Gemma 4 在所有"会读图、读文档、读视频、读音频"的模型里处于什么位置。生成侧在 Part II 展开（[20](20-image-generation/index.md)、[21](21-video-generation/landscape.md)、[22](22-audio-generation/index.md)、[23](23-unified-omni/landscape.md)）。
